package com.cloudxanh.multipleimagelikefacebook.widget
...
import com.cloudxanh.multipleimagelikefacebook.R
import com.cloudxanh.multipleimagelikefacebook.widget.SpannedGridLayoutManager.SpanInfo
...
class MediaGridView : RecyclerView {
    ...
    constructor(context: Context, attributeSet: AttributeSet?) : super(context, attributeSet) {
        type =
            attributeSet?.let {
                val typedArray =
                    context.obtainStyledAttributes(attributeSet, R.styleable.MediaGridView)
                        ...
                        val spanCount = when (adapter?.itemCount ?: childCount) {
                            ...
                            3 -> {
                                when (position) {
                                    ...
                                    else -> return@GridSpanLookup SpanInfo(
                                        2,
                                        3
                                    )
                                }
